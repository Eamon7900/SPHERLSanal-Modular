...
void makeRadialProFromColBin(DataFile& bin){//updated
  ...
  ofFile<<std::setw(nWidthIntOutputField)<<"Zone_#"
    <<std::setw(nWidthOutputField)<<"M_r_im1half"
    <<std::setw(nWidthOutputField)<<"DM_r"
    <<std::setw(nWidthOutputField)<<"ErrorDM_r"
    <<std::setw(nWidthOutputField)<<"R_im1half"
    <<std::setw(nWidthOutputField)<<"R_ip1half"
    <<std::setw(nWidthOutputField)<<"<D>"
    <<std::setw(nWidthOutputField)<<"D_max"
    <<std::setw(nWidthIntOutputField)<<"D_max_j"
    <<std::setw(nWidthIntOutputField)<<"D_max_k"
    <<std::setw(nWidthOutputField)<<"D_min"
    <<std::setw(nWidthIntOutputField)<<"D_min_j"
    <<std::setw(nWidthIntOutputField)<<"D_min_k"
    <<std::setw(nWidthOutputField)<<"U_ave_im1half"
    <<std::setw(nWidthOutputField)<<"U_max_im1half"
    <<std::setw(nWidthIntOutputField)<<"U_max_j"
    <<std::setw(nWidthIntOutputField)<<"U_max_k"
    <<std::setw(nWidthOutputField)<<"U_min_im1half"
    <<std::setw(nWidthIntOutputField)<<"U_min_j"
    <<std::setw(nWidthIntOutputField)<<"U_min_k"
    <<std::setw(nWidthOutputField)<<"U0"
    <<std::setw(nWidthOutputField)<<"V_ave"
    <<std::setw(nWidthOutputField)<<"V_max"
    <<std::setw(nWidthIntOutputField)<<"V_max_j"
    <<std::setw(nWidthIntOutputField)<<"V_max_k"
    <<std::setw(nWidthOutputField)<<"V_min"
    <<std::setw(nWidthIntOutputField)<<"V_min_j"
    <<std::setw(nWidthIntOutputField)<<"V_min_k"
    <<std::setw(nWidthOutputField)<<"W_ave"
    <<std::setw(nWidthOutputField)<<"W_max"
    <<std::setw(nWidthIntOutputField)<<"W_max_j"
    <<std::setw(nWidthIntOutputField)<<"W_max_k"
    <<std::setw(nWidthOutputField)<<"W_min"
    <<std::setw(nWidthIntOutputField)<<"W_min_j"
    <<std::setw(nWidthIntOutputField)<<"W_min_k"
    <<std::setw(nWidthOutputField)<<"Q"
    <<std::setw(nWidthOutputField)<<"Q_max"
    <<std::setw(nWidthIntOutputField)<<"Q_max_j"
    <<std::setw(nWidthIntOutputField)<<"Q_max_k"
    <<std::setw(nWidthOutputField)<<"Q_min"
    <<std::setw(nWidthIntOutputField)<<"Q_min_j"
    <<std::setw(nWidthIntOutputField)<<"Q_min_k"
    <<std::setw(nWidthOutputField)<<"E_ave"
    <<std::setw(nWidthOutputField)<<"E_max"
    <<std::setw(nWidthIntOutputField)<<"E_max_j"
    <<std::setw(nWidthIntOutputField)<<"E_max_k"
    <<std::setw(nWidthOutputField)<<"E_min"
    <<std::setw(nWidthIntOutputField)<<"E_min_j"
    <<std::setw(nWidthIntOutputField)<<"E_min_k"
    <<std::setw(nWidthOutputField)<<"T_ave"
    <<std::setw(nWidthOutputField)<<"T_max"
    <<std::setw(nWidthIntOutputField)<<"T_max_j"
    <<std::setw(nWidthIntOutputField)<<"T_max_k"
    <<std::setw(nWidthOutputField)<<"T_min"
    <<std::setw(nWidthIntOutputField)<<"T_min_j"
    <<std::setw(nWidthIntOutputField)<<"T_min_k"
    <<std::setw(nWidthOutputField)<<"Kap_ave"
    <<std::setw(nWidthOutputField)<<"Kap_min"
    <<std::setw(nWidthOutputField)<<"Kap_max"
    <<std::setw(nWidthOutputField)<<"L_rd_im1half"
    <<std::setw(nWidthOutputField)<<"L_cv_im1half"
    <<std::setw(nWidthOutputField)<<"F_cv_ave"
    <<std::setw(nWidthOutputField)<<"F_cv_max"
    <<std::setw(nWidthOutputField)<<"F_cv_min"
    <<std::setw(nWidthOutputField)<<"KEP"
    <<std::setw(nWidthOutputField)<<"KETot"
    <<std::setw(nWidthOutputField)<<"P_ave"
    <<std::setw(nWidthOutputField)<<"P_min"
    <<std::setw(nWidthOutputField)<<"P_max"
    <<std::setw(nWidthOutputField)<<"Gam_ave"
    <<std::setw(nWidthOutputField)<<"Gam_min"
    <<std::setw(nWidthOutputField)<<"Gam_max"
    <<std::setw(nWidthOutputField)<<"C_ave"
    <<std::setw(nWidthOutputField)<<"C_max"
    <<std::setw(nWidthIntOutputField)<<"C_max_j"
    <<std::setw(nWidthIntOutputField)<<"C_max_k"
    <<std::setw(nWidthOutputField)<<"C_min"
    <<std::setw(nWidthIntOutputField)<<"C_min_j"
    <<std::setw(nWidthIntOutputField)<<"C_min_k"
    <<std::setw(nWidthOutputField)<<"UpFillFac";
  if(bin.bExtraInfoInProfile){
    ofFile<<std::setw(nWidthOutputField)<<"DlnPDlnT"
      <<std::setw(nWidthOutputField)<<"DlnPDlnRho"
      <<std::setw(nWidthOutputField)<<"DEDT";
  }
  ofFile<<std::endl;
