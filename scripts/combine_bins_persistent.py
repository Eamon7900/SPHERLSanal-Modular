...
# Usage: combine_bins_persistent.py [options] BASEFILENAME

# Used to combine binary files while a program is running. It does this by
# continuously checking to see if new files exists and if they do combining
# them. It will continue doing this until "ctrl+c" is pressed.
