...
# Usage: light_curve.py [options] XMLFILE

# Reads in the XMLFILE which specifies how the light curve is to be made. see
# light_curve_reference.xml for a template xml file to be used with this script.
# Found in the SPHERLS directory docs/templateXML.
