...
# Usage: rm_files.py [options] BASEFILENAME[START-END]

# Removes a range of file matching BASEFILENAME_tXXXXXXXX with XXXXXXXX being a
# zero padded number starting with START and continuing to but not including
# END. Ex. there are a number of files in the current directory from
# run1_t00000000, to run1_t00012300, one could remove all these files with the
# command rm_files.py run1_t[0-12300] or rm_files.py run1_t[0-*]. The "*" wild
# character is used to include all files upto the maximum integer starting from
# START.
