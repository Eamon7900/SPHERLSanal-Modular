...
# Usage: make_vtk.py [options] BASEFILENAME[START-END]

# Creates vtk files (*.vts) from a range of combined binary files starting with
...
# command make_vtk.py run1_t[0-12300] or make_vtk.py run1_t[0-*]. The "*" wild
# character is used to include all files up to the maximum integer starting from
# START.
