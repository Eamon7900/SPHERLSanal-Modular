...
# Usage: period_from_PKE_ave.py [options] INPUTFILE

# Creates a list of times and periods. The expected input file is one created by
# average_PKE.py "average_PKE.txt" which it reads in and calculated periods
# based on thethe time between every other peak, as there are two peaks in the
# kinetic energy every period.
