...
#Usage: fit_light_curves.py [options] INPUTFILE

#Fits input to a series of fits composed of data points, the fit quality is
#evaluated using the algorithms from calculate_residuals_of_light_curve_fit
...
def makeFits(fits):
  ...
  for fitSettings in fits:
    print("fitting ",fitSettings['input'], end=' ')
