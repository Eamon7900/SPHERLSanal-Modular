...
# Usage: cp_files.py [options] BASEFILENAME[START-END] NEWBASEFILENAME
...
# run1_t00012300, one could copy all these files with the command cp_files.py
# run1_t[0-12300] run2 or cp_files.py run1_t[0-*] run2. The "*" wild character
...
# distributed files, profiles, 2D slices etc.
