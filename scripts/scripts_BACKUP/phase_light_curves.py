...
# Usage: phase_light_curves.py [options] XMLFILE

# Reads in the XMLFILE which specifies the stars to phase.
...
def main():
  ...
  for line in f:
    ...
    if nameTmp!=nameTmpOld or filterTmp!=filterTmpOld:
      ...
      if not(nameTmpOld in list(stars.keys())):#don't have a dictionary yet
