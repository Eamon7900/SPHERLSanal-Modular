...
#Usage: combine_bins.py [options] BASEFILENAME[START-END]

# Combines a range of binary files starting with BASEFILENAME with time step
# indices including START upto but not including END. Ex. there are a number of
# files in the current directory from run1_t00000000, to run1_t00012300, one
# could combine all these files with the command combine_bins.py run1_t[0-12301]
# or combine_bins.py run1_t[0-*]. The "*" wild character is used to include all
