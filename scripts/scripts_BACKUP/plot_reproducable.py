...
# Usage: plot_reproducable.py [options] INPUT1 INPUT2

# Creastes plots of phased variables. The phase is determined using INPUT1 (a
# watchzone file) and applied to INPUT2 (a second watchZone file. The watchZone
# file used for phasing should be near the node of the first overtone so that it
# will be assured that the phase is of the fundamental mode.
