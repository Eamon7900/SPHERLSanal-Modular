...
# Usage: plot_max_variance_exploring.py [options] BASEFILENAME[START-END]

# Creates a plot of maximum variance of temperature and theta velocity along
# side the radial grid velocity as a function of time. The input files should be
# created using "make_profiles.py" or "SPHERLSanal". The resulting plot will be
# saved as max_variance.FMT where. OUTPUTFILE can be specified with the "-o"
# option and defaults to "tmp".
